...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = `DELETE FROM movie_directors
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = `DELETE FROM movie_actors
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = `DELETE FROM movie_keywords
  ...
  it(
    ...
    async done => {
      const companyId = 12;
      const query = `DELETE FROM movie_production_companies
